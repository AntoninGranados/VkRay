...
inline const ComponentType TiltShiftLens = ComponentType::builder("tilt_shift_lens")
    ...
    .field<float>("shift_y", 0.0f, NumericMeta{ .step = 0.01f }, true)
    .build();
...
inline const ComponentType CameraLensPlugin = ComponentType::builder("programmable_lens")
    .description("Programmable custom lens, defined by a GLSL shader-definition file.")
    .icon(ICON_FA_CODE)
    .group("camera")
    .needs("camera")
